    ...
    def __init__(self, sentence='', phrases=None, rules=None,
        ...
        for rule in self.__rules:
            ...
            for phrase in self.__phrases:
                if rule[3].search(phrase):
                    rule_out_phrases.add(phrase)
        self.__phrases = [p for p in self.__phrases if p not in rule_out_phrases]
        for phrase in self.__phrases:
        ...
        if negP:
            ...
            self.__negTaggedSentence = ''.join(sb4).strip()
